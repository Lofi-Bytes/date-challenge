...
/**
 * Define startDate and endDate, so we can get the date range
 */
const startDate = parseDate('2021-07-05')
const endDate = parseDate('2021-11-05')
...
daysInRange = daysInRange.reverse()
...
const data = {
  labels: labels,
  datasets: [{
    label: '# of dates in each date range',
